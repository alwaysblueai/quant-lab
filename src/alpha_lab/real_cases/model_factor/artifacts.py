...
def export_artifact_bundle(
    *,
    ...
    model_factor_result.training_log_df.to_csv(paths["training_log"], index=False)
    model_factor_result.feature_importance_df.to_csv(paths["feature_importance"], index=False)
    ...
    _write_json(
        paths["model_definition_json"],
        {
            ...
            "feature_preprocess": _to_jsonable(spec_to_dict(spec).get("feature_preprocess", {})),
